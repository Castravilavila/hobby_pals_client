...
export function PostCard(props){
    ...
    return(
        <GridItem key={props.post.id} xs={ props.nr===2?6 : props.nr===4?3 : props.nr===6?2:4} sm={props.nr===2?6 : props.nr===4?3 : props.nr===6?2:4} md={ props.nr===2?6 : props.nr===4?3 : props.nr===6?2:4} lg={ props.nr===2?6 : props.nr===4?3 : props.nr===6?2:4} xl={props.nr===2?6 : props.nr===4?3 : props.nr===6?2:4} style={{marginTop: "0px", marginBottom: "0px"}}>
                                        <Card plain blog>
